  ...
  return (
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>We implement a customer friendly approact to out billing system. With the implementation of newer technologies, we aim to give you 100% control over your money.</p>
